...
background-image: url("images/01-basics/rstd-proj-work.png")
background-size: 70%
background-position: center bottom
...
background-image: url("images/01-basics/rstd-proj-work2.png")
background-size: 70%
background-position: center bottom
...
##- To use R package write one time `library(name of the package)` inside your script  
...
# 🤷🏽‍♂️  * how to convert these variables into a **tidy** data*
...
class: hide-count
background-image: url("images/01-basics/tidydata_1.jpg")
background-size: contain

---

class: hide-count
background-image: url("images/01-basics/tidydata_2.jpg")
background-size: contain
